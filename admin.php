                    ...
                    <div class="card">
                        <div class="card-content">
                            ...
                            <form id="notification-form">
                                ...
                                <button type="button" id="subscribe-push" class="btn-flat waves-effect">
                                    <i class="material-icons left">notifications</i>Subscribe to Push
                                </button>
                                ...
                                <button type="button" id="direct-system-notification" class="btn-flat waves-effect">
                                    <i class="material-icons left">notifications_active</i>Direct System Test
                                </button>
                            </form>
                        </div>
                    </div>
